package tiendaOnline.sucursal.exception;
...
import tiendaOnline.sucursal.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> sucursalNoEncontrado(SucursalNoEncontradoException ex,
                                                             HttpServletRequest request) {
        log.warn("Sucursal no encontrada. Ruta: {} - Mensaje: {}", request.getRequestURI(), ex.getMessage());
