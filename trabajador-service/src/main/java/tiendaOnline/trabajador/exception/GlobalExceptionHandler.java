package tiendaOnline.trabajador.exception;
...
import tiendaOnline.trabajador.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> trabajadorNoEncontrado(TrabajadorNoEncontradoException ex,
                                                                HttpServletRequest request) {
        log.warn("Trabajador no encontrado. Ruta: {} - Mensaje: {}", request.getRequestURI(), ex.getMessage());
