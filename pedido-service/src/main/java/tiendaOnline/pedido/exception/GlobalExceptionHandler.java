...
import tiendaOnline.pedido.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> pedidoNoEncontrado(PedidoNoEncontradoException ex, HttpServletRequest request) {
        log.warn("Pedido no encontrada. Ruta: {} - Mensaje: {}", request.getRequestURI(), ex.getMessage());
