package tiendaOnline.distribuidor.exception;
...
import tiendaOnline.distribuidor.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> distribuidorNoEncontrado(DistribuidorNoEncontradoException ex,
                                                             HttpServletRequest request) {
        log.warn("Distribuidor no encontrado. Ruta: {} - Mensaje: {}", request.getRequestURI(), ex.getMessage());
