...
package tiendaOnline.Pago.exception;
...
import tiendaOnline.Pago.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> resenaNoEncontrada(PagoNoEncontradoException ex, HttpServletRequest request) {
        log.warn("Pago no encontrada. Ruta: {} - Mensaje: {}", request.getRequestURI(), ex.getMessage());
