...
package tiendaOnline.resena.exception;
...
import tiendaOnline.resena.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> validacion(MethodArgumentNotValidException ex, HttpServletRequest request) {
        log.warn("Error en la validación en la ruta {}", request.getRequestURI());
    ...
    @ExceptionHandler(ReseñaNoEncontradaException.class)
    public ResponseEntity<ErrorResponse> resenaNoEncontrada(ReseñaNoEncontradaException ex, HttpServletRequest request) {
        log.warn("Reseña no encontrada. Ruta: {} - Mensaje: {}", request.getRequestURI(), ex.getMessage());
    ...
    public ResponseEntity<ErrorResponse> errorGeneral(Exception ex, HttpServletRequest request) {
