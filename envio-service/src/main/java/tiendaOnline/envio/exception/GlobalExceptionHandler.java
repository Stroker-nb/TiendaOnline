package tiendaOnline.envio.exception;
...
import tiendaOnline.envio.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> clienteNoEncontrado(EnvioNoEncontradoException ex,
                                                             HttpServletRequest request) {
        log.warn("Envio no encontrado. Ruta: {} - Mensaje: {}", request.getRequestURI(), ex.getMessage());
